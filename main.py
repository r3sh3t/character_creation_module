...
def attack(char_name: str, char_class: str) -> str:
    """Функция атаки в зависимости от класса."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция для защиты в зависимости от класса."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция умений в зависимости от класса."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    ...
    Сначала проверяется класс,
    После этого предлагаются варианты:
    атаковать, защититься, использовать спелл.
    """
    if char_class == 'warrior':
